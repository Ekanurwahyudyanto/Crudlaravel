...
Route::get('/contact',[EmployeeController::class,'contact'])->name('contact')->middleware('auth');

Route::get('/admin',[EmployeeController::class,'admin'])->name('admin')->middleware('auth');
